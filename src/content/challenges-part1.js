...

  {
    ...
    html: {
      de: story(
        ...
        <div style="height:108px;width:250px;background-color:#663399;position:relative;margin-bottom:16px;"><img src="/chals/55.png"><div style="position:absolute;right:4px;bottom:2px;"><small style="color:black;font-size:11px;">rgb(102,51,153)</small></div></div>
