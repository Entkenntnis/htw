...
export const communityChallenges = [
  {
    ...
    render: async ({ App, req }) => {
      ...
      return req.lng.startsWith('de')
        ...
        <p>Gelöste Aufgaben geben keine Punkte, dafür werden sie als gelbe Badge neben deinem Namen in der Highscore angezeigt. Für die Aktivität gibt es eine <a href="/community/activity">separate Übersicht</a>. Wer die meisten Aufgaben erstellt hat, findest du in der <a href="/highscore?sort=creators">Ersteller-Bestenliste</a>.</p>
      ...
      `
        ...
        <p>Solved challenges don't award points; instead, they appear as a yellow badge next to your name in the highscore. For activity, there's a <a href="/community/activity">separate overview</a>. Who created the most challenges can be found in the <a href="/highscore?sort=creators">creator leaderboard</a>.</p>
