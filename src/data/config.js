     ...
     ${
       showEnough
         ? '<a href="/enough" style="position:absolute;left:1360px;top:415px;" class="text-reset text-decoration-none fade-in"><div>&nbsp;&nbsp;&nbsp;Enough</div><img src="/enough.png" style="width:65px;margin-top:6px;"></a>' +
           '<a href="/wer-wird-wort-millionaer" style="position:absolute;left:140px;top:955px;" class="text-reset text-decoration-none fade-in"><img src="/wwwm.png" style="width:78px;"></a>'
         : ''
     }
     ${
       ...
       showStatsLinks
         ? '<div style="position: absolute; left: 1000px; top: -25px;"><a href="/mapflow">MapFlow</a><a href="/events" style="margin-left: 24px;">Events</a><a href="/survey" style="margin-left: 24px;">Survey</a><a href="/questions" style="margin-left: 24px;">Questions</a></div>'
         : ''
     }
  `
    },
